...
import { changeMode, logoutUser } from "../features/auth/authSlice";
...
const Header = () => {
  ...
  useEffect(() => {
    console.log("loginState:",userId,isLoggedIn);
  }, [isLoggedIn,userId]);
            ...
            <div className="dropdown dropdown-end">
              <label tabIndex={0} className="btn btn-ghost btn-circle avatar">
                <div className="w-10 rounded-full">
                  <img src={`http://localhost:5139/images/${pic?.imageUrl}`} />
                </div>
              </label>
              <ul
                tabIndex={0}
              ...
              >
                ...
                {pic?.role==="Admin" && <li>
                  <Link to="dashboard" className="text-accent-content">
                    Dashboard
                  </Link>
                </li>}
                {pic?.role==="Admin" && <li>
                  <Link to="addproduct" className="text-accent-content">
                  AddProduct
                  </Link>
                </li>}
                <li>
        ...
        <div className="drawer">
          ...
          <div className="drawer-side z-10">
            ...
            <FaWindowClose className="text-3xl ml-auto" />
              ...
              <li className="text-xl">
                <NavLink className="text-accent-content" to="/home">
